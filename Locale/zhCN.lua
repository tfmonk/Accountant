...
L["All Chars"] = "所有角色"
L["Alliance"] = true
L["Are you sure you want to reset the data? This can't be undone"] = "你确定要重置数据吗?这个操作无法恢复!"
L["Auction House"] = "拍卖行"
...
L["Clear the Accountant data for all characters"] = "清除所有角色的统计数据"
L["complete"] = "完成"
...
L["Mail"] = "邮件"
L["Merchants"] = "商人"
L["Merge Accountant data from one character to another"] = "角色数据合并"
